...
public class NativeVerticalScrollbar_ResourcesTransparant_default_StaticClientBundleGenerator implements com.google.gwt.user.client.ui.NativeVerticalScrollbar.ResourcesTransparant {
  private static NativeVerticalScrollbar_ResourcesTransparant_default_StaticClientBundleGenerator _instance0 = new NativeVerticalScrollbar_ResourcesTransparant_default_StaticClientBundleGenerator();
  private void nativeVerticalScrollbarStyleInitializer() {
    nativeVerticalScrollbarStyle = new com.google.gwt.user.client.ui.NativeVerticalScrollbar.Style() {
      ...
      public String getText() {
        return (".GEWCVAHDI{opacity:" + ("0.7")  + ";filter:" + ("alpha(opacity = 70)")  + ";-webkit-transition:" + ("opacity"+ " " +"350ms")  + ";-moz-transition:" + ("opacity"+ " " +"350ms")  + ";-o-transition:" + ("opacity"+ " " +"350ms")  + ";transition:" + ("opacity"+ " " +"350ms")  + ";}.GEWCVAHDI:hover{opacity:" + ("1")  + ";filter:" + ("alpha(opacity = 100)")  + ";}");
      }
