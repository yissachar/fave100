...
public class CustomScrollPanel_Resources_default_StaticClientBundleGenerator implements com.google.gwt.user.client.ui.CustomScrollPanel.Resources {
  private static CustomScrollPanel_Resources_default_StaticClientBundleGenerator _instance0 = new CustomScrollPanel_Resources_default_StaticClientBundleGenerator();
  private void customScrollPanelStyleInitializer() {
    customScrollPanelStyle = new com.google.gwt.user.client.ui.CustomScrollPanel.Style() {
      ...
      public String getText() {
        return (".GEWCVAHAI{background:" + ("#efefef")  + ";}");
      }
