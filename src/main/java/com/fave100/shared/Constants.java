...
public class Constants {
	...
	public static final String SEARCH_URL = "https://env-6652118.jelastic.servint.net/1/search?";
	public static final String LOOKUP_URL = "https://env-6652118.jelastic.servint.net/1/lookup?";
