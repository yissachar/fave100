...
/*
 * Modified by Yissachar Radcliffe to use TolerantJsonSerialization
 */
 ...
 * server over HTTP. This module requires a {@link XCSRFHeaderName}. By default, this will be bound to {@link RestDispatchAsyncModule#DEFAULT_X_CSRF_NAME}.
 * <p/>
 ...
 */
public class TolerantRestDispatchAsyncModule extends AbstractDispatchAsyncModule {
	/**
	 * A {@link RestDispatchAsyncModule} builder.
	 * <p/>
	 * By default, this builder configures the {@link XCSRFHeaderName} value to {@link RestDispatchAsyncModule#DEFAULT_X_CSRF_NAME}.
	 */
	public static class Builder extends AbstractDispatchAsyncModule.Builder {
		...
		@Override
		public TolerantRestDispatchAsyncModule build() {
			return new TolerantRestDispatchAsyncModule(this);
		}
	}
	 ...
	 */
	public TolerantRestDispatchAsyncModule() {
		this(new Builder());
	}

	private TolerantRestDispatchAsyncModule(Builder builder) {
		super(builder);
